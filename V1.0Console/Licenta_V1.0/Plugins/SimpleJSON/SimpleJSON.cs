...
namespace SimpleJSON
{
    ...
    public abstract class JSONNode
    {
        ...
        public static implicit operator JSONNode(List<string> list)
        {
            return (JSONArray)list;
        }

        public static implicit operator JSONNode(List<float> list)
        {
            return (JSONArray)list;
        }
    ...
    public class JSONArray : JSONNode, IEnumerable
    {
        ...
        public static implicit operator JSONArray(List<string> list)
        {
            JSONArray jsonArr = new JSONArray();
            foreach (string val in list)
            {
                jsonArr.m_List.Add(new JSONData(val));
            }
            return jsonArr;
        }

        public static implicit operator JSONArray(List<float> list)
        {
            JSONArray jsonArr = new JSONArray();
